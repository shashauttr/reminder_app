...
class _TodoListState extends State<TodoList> {
  ...
  _shareTheApp() {
    Share.share(
        'I\'m using reminder app to keep myself organized! Try it out for yourself: http://play.google.com');
  }

  _showDialogBox(value) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            'This is a task reminder app by Vortex App Labs.',
